...
vim.keymap.set('n', '<leader>ds', function() require('dap').step_over() end, {desc = "Debug Step Over"})
...
vim.keymap.set('n', '<leader>dd', function() require('dap').disconnect(); require('dap').close() end, {desc = "Debug Disconnect"})
